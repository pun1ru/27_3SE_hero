...
void MadWickAHRSUpdate(MadWickAHRS *m,
    ...
    if(!((ax == 0.0f) && (ay == 0.0f) && (az == 0.0f))){
        ...
        s1 = q_4q1 * q3q3 - q_2q3 * ax + 4.0f * q0q0 * q1 - q_2q0 * ay - q_4q1 + q_8q1 * q1q1 + q_8q1 * q2q2 + q_4q1 * az;
        s2 = 4.0f * q0q0 * q2 + q_2q0 * ax + q_4q2 * q3q3 - q_2q3 * ay - q_4q2 + q_8q2 * q1q1 + q_8q2 * q2q2 + q_4q2 * az;
    ...
    m->Roll = asinf(-2.0f * (m->q[1] * m->q[3] - m->q[0] * m->q[2])) * 57.295779513f;
}
