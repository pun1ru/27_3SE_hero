...
#define WHEEL_RPM_TO_WHEEL_MPS (2 * ROBOT_PI * WHEEL_RADIUS / 60.0f / M3508_REDUCTION_RATIO) // * MOTOR_MECHENICAL_SPEED
#define WHEEL_MPS_TO_WHEEL_RPM (1 / (WHEEL_RPM_TO_WHEEL_MPS*1.0f)) // * m/s speed
#define ROBOT_RPS_TO_WHEEL_MPS (2 * ROBOT_PI * ROBOT_CENTER_TO_WHEEL_RADIUS) // * RPS
...
#define ESTIMATE_TASK_PERIOD_SET      IMU_TASK_PERIOD_SET
