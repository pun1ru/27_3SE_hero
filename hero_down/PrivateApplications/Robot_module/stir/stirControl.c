...
static void shoot_update_input_target(void){
    stir_target_pos_rad = stir_target_pos / STIR_DEGREES_PER_RADIAN * ROBOT_PI;
    stir_all_target_pos_rad = stir_all_target_pos_d / STIR_DEGREES_PER_RADIAN * ROBOT_PI;
...
void GetStirRealAngle(void){
    ...
    stir_real_angle_rad = stir_real_angle / STIR_DEGREES_PER_RADIAN * ROBOT_PI;
}
