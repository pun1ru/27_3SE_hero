...
static uint8_t write_BMI088_accel_reg_data_error[BMI088_WRITE_ACCEL_REG_NUM][3] =
    {
        ...
        {BMI088_ACC_RANGE, BMI088_ACC_RANGE_12G, BMI088_ACC_RANGE_ERROR},
...
void BMI088_read(int16_t gyro[3], int16_t accel[3], int16_t *temperate)
{
...
//			gyro[0] = gyro[0]*0.87+0.13*((int16_t)((buf[3]) << 8) | buf[2]);
//      gyro[1] = gyro[0]*0.87+0.13*((int16_t)((buf[5]) << 8) | buf[4]);
//      gyro[2] = gyro[0]*0.87+0.13*((int16_t)((buf[7]) << 8) | buf[6]);
    }
    BMI088_accel_read_muli_reg(BMI088_TEMP_M, buf, 2);

    *temperate = (int16_t)((buf[0] << 3) | (buf[1] >> 5));
